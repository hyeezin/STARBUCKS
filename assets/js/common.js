...
promotionToggleBtn.addEventListener('click', function(){
    isHidePromotion = !isHidePromotion // !뒤에 있는 값 반대로 출력 => isHidePromotion = true
    if (isHidePromotion) {
        //isHidePromotion 값이 true 
        //숨김처리
        promotionEl.classList.add('hide');
    } else {
        //isHidePromotion 값이 false
        //보임처리
...
thisYear.textContent = new Date().getFullYear(); // 올해년도 노출
